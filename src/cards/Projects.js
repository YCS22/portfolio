...
function ProjectInstance({ name, link }) {
  return (
    <div className="rounded-md w-1/2 sm:w-1/3 h-1/3  sm:h-auto m-5 transition duration-500 ease-in-out p-1 shadow-2xl  bg-primary-hint hover:bg-primary-fueltown  transform hover:-translate-y-1 hover:scale-110  text-center cursor-pointer">
